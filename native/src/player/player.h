...
int player_is_video_hw_enabled(Player* player);
int player_get_video_hw_backend(Player* player);
int player_get_video_hw_policy(Player* player);
uint64_t player_get_video_hw_frame_token(Player* player);
